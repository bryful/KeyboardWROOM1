...
static const String defaultFileName = "/profiles_default.json"; // デフォルトプロファイルファイル名

const String initJson = "{\"profiles\":[{\"name\":\"explorer\",\"color\":65535,\"keys\":[8,0,0,0,7,0,0,1,2,4,1,16,2,76,1,15,2,58,14,32,2,59,14,33,2,60,14,34,2,61,14,48,2,62,14,36,2,63,14,50,2,29,0,18,2,24,0,46,2,6,1,14,2,26,1,38,2,25,1,39,2,29,1,2],\"rotaries\":[0,0,0,0,49,0,0,0,0,0,0,0,49,0,0,0,0,0,0,0,49,0,0,0]},{\"name\":\"After Effects\",\"color\":31,\"keys\":[8,0,0,0,7,0,0,1,2,76,4,16,2,76,0,15,1,0,2,7,1,0,1,8,1,0,4,9,5,0,0,10,2,25,0,17,2,11,0,45,2,29,0,18,2,24,0,46,2,8,0,47,2,15,0,12,1,44,0,13,2,29,1,2],\"rotaries\":[45,9,0,0,35,2,74,0,75,78,0,0,19,0,0,0,0,0,0,0,49,0,0,0]},{\"name\":\"Photoshop\",\"color\":63488,\"keys\":[8,0,0,0,7,0,0,1,2,76,4,16,2,76,0,15,1,0,1,8,1,0,2,7,1,0,4,9,5,0,0,10,2,6,0,4,2,10,0,6,2,5,0,3,2,4,1,37,2,12,6,30,2,7,1,29,1,44,0,13,2,29,1,31],\"rotaries\":[30,31,0,0,19,0,0,0,47,48,0,0,20,0,0,0,87,86,1,1,18,0,0,0]},{\"name\":\"Illustrator\",\"color\":65504,\"keys\":[8,0,0,0,7,0,0,1,2,25,0,17,2,76,0,15,1,0,2,7,1,0,1,8,1,0,4,9,5,0,0,10,2,19,0,21,2,4,0,22,2,46,2,23,2,45,0,24,2,6,2,25,2,13,1,26,1,44,0,13,2,29,1,2],\"rotaries\":[46,45,1,1,18,2,39,1,0,0,0,0,19,2,30,6,47,48,0,0,20,0,0,0]},{\"name\":\"GIMP\",\"color\":2047,\"keys\":[8,0,0,0,7,0,0,1,2,54,1,16,2,76,0,15,1,0,2,7,1,0,1,8,1,0,4,9,5,0,0,10,2,19,0,3,2,17,0,4,2,8,2,5,2,5,2,6,2,21,0,11,2,9,0,12,1,44,0,13,2,29,1,2],\"rotaries\":[78,75,1,1,19,2,30,2,47,48,0,0,20,2,49,0,87,86,0,0,18,2,13,6]},{\"name\":\"Inkscape\",\"color\":63519,\"keys\":[8,0,0,0,7,0,0,1,2,17,0,17,2,76,0,15,1,0,2,7,1,0,1,8,1,0,4,9,5,0,0,10,2,5,0,21,2,4,0,27,2,7,0,28,2,24,0,6,2,29,0,11,2,23,0,28,1,44,0,13,2,29,1,2],\"rotaries\":[46,45,1,1,18,2,30,0,0,0,0,0,19,2,30,6,54,55,0,0,20,0,0,0]},{\"name\":\"FireAlpaca\",\"color\":64512,\"keys\":[8,0,0,0,7,0,0,1,2,73,0,16,2,76,0,15,1,0,2,7,1,0,1,8,1,0,4,9,5,0,0,10,2,5,0,3,2,5,2,4,2,8,0,5,2,10,0,6,2,16,0,11,2,15,0,12,1,44,0,13,2,29,1,2],\"rotaries\":[87,80,0,0,19,2,82,0,47,48,0,0,20,2,49,0,87,86,1,1,18,2,39,1]}]}";
...
void ProfileManager::initDefaultProfiles()
{
    ...
    else
    {
        ...
        saveProfilesToFile(defaultFileName);
...
void ProfileManager::saveDefaultProfiles()
{
    ...
    saveFile(defaultFileName, initJson);
}
